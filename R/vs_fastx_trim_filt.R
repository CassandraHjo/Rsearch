...
#' @param maxlen The maximum number of bases for a given sequence. Sequences with more
#' bases than the specified number are discarded. Defaults to \code{NULL}.
#' @param maxns The maximum number of N's for a given sequence. Sequences with more N's
#' than the specified number are discarded. Defaults to \code{0}.
#' @param maxsize The maximum abundance for a given sequence. Sequences with abundance
...
#' @param trunclen The sequences are truncated to the specified length. Shorter sequences
